...
* `Social support`: the national average of the binary responses (either 0 or 1) to the GWP(Gallup World Poll) question “If you were in trouble, do you have relatives or friends you can count on to help you whenever you need them, or not?”(we renamed it as gdp in dataset)
...
In the original data, they use log to get the result of GDP, we try to transfer it back to the real scale. We divide these countries into developing and developed country by the criteria that some [economists](https://www.investopedia.com/updates/top-developing-countries/) prefer to see a country with per capita GDP of at least $25,000 to be declared as developed. In the original data, they use log get the result, we transfer it in the real way to find cutpoint for developed and developing country.
...
### **How do the happiness scores of all countries change over time?** 
...
In this report, we explore the world happiness score changing trend and associate factors in worldwide, by region and by developing level. Although the happiness score slightly increases from 2007 to 2018 in the worldwide level, several regions have decreasing trends, and when performing stratified analysis by developing level, developed countries also have decreasing trend. Further explore using our map and app, we can find that as the economy develops to higher level, the increasing rate of happiness score is decreasing. Since the material increase can not fit the demand of people, we explore more on the association factors to the happiness score.
